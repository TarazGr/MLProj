...
data = pd.read_csv('billboard_2000_2018_spotify_lyrics.csv', encoding='latin1', na_values=['unknown', 'NaN'], header=0).dropna(how="any")
...
toMerge = pd.read_csv('datasetFINAL.csv', header=0, names=["index","title","artist","billboarder","danceability","energy","loudness","speechiness","acousticness","instrumentalness","liveness","key","mode","duration"])

toMerge = toMerge[["title","artist","billboarder","danceability","energy","loudness","speechiness","acousticness","instrumentalness","liveness","key","mode","duration"]]
