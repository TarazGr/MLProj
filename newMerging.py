...
mean_data.to_csv("Bran New Dataset (mean sub).csv", encoding="latin1", index=False)
interpolated_data.to_csv("Bran New Dataset (interpolated).csv", encoding="latin1", index=False)
